...
function capitalizar(nome) {
    let nomeStr = nome.charAt(0).toUpperCase() + nome.substr(1).toLowerCase()
    return nomeStr
...
function truncar(palavra, comprimentoMax = 5) {
    if(palavra !=''){
        let contagemDeletra = palavra.length
        if(contagemDeletra > comprimentoMax){
